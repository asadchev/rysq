...
namespace rysq {
  ...
  struct Kernel2e {
    ...
    Kernel2e(const Bra &bra, const Ket &ket, Parameters = Parameters{})
      : bra(bra), ket(ket)
    {
    }
  ...
  std::unique_ptr<Kernel2e2> kernel(const Bra<1> &bra, const Ket<1> &ket, const Parameters& = {});

  std::unique_ptr<Kernel2e3> kernel(const Bra<2> &bra, const Ket<1> &ket, const Parameters& = {});

  std::unique_ptr<Kernel2e4> kernel(const Bra<2> &bra, const Ket<2> &ket, const Parameters& = {});
